...
<KeyboardAvoidingView behavior="padding" style={styles.mainContainer}>
  ...
  <View style={styles.parentData}>
    {renderTextInput('shop name', vendorData.shopName, 'shopName')}
    {renderTextInput('contact Info', vendorData.contactInfo, 'contactInfo')}
    {renderTextInput('school', vendorData.school, 'school')}
    {renderTextInput('shopBal', vendorData.shopBal, 'shopBal')}
  </View>
